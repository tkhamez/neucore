...
final class Version20200530230354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE watchlist_manager_group (watchlist_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_2612D96183DD0D94 (watchlist_id), INDEX IDX_2612D961FE54D947 (group_id), PRIMARY KEY(watchlist_id, group_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
