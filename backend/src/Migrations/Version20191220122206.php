...
final class Version20191220122206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE watchlist_blacklist_corporation (watchlist_id INT NOT NULL, corporation_id BIGINT NOT NULL, INDEX IDX_8DDD9A7183DD0D94 (watchlist_id), INDEX IDX_8DDD9A71B2685369 (corporation_id), PRIMARY KEY(watchlist_id, corporation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_blacklist_alliance (watchlist_id INT NOT NULL, alliance_id BIGINT NOT NULL, INDEX IDX_71972D2C83DD0D94 (watchlist_id), INDEX IDX_71972D2C10A0EA3F (alliance_id), PRIMARY KEY(watchlist_id, alliance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_whitelist_corporation (watchlist_id INT NOT NULL, corporation_id BIGINT NOT NULL, INDEX IDX_82FF578E83DD0D94 (watchlist_id), INDEX IDX_82FF578EB2685369 (corporation_id), PRIMARY KEY(watchlist_id, corporation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_whitelist_alliance (watchlist_id INT NOT NULL, alliance_id BIGINT NOT NULL, INDEX IDX_AF2D6D8683DD0D94 (watchlist_id), INDEX IDX_AF2D6D8610A0EA3F (alliance_id), PRIMARY KEY(watchlist_id, alliance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
