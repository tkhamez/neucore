...
class Version20180417115425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_applicant (player_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_A1E4CF899E6F5DF (player_id), INDEX IDX_A1E4CF8FE54D947 (group_id), PRIMARY KEY(player_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
