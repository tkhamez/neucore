...
final class Version20191119192648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE watchlists (id INT NOT NULL, name VARCHAR(32) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_player (watchlist_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_310B07AD83DD0D94 (watchlist_id), INDEX IDX_310B07AD99E6F5DF (player_id), PRIMARY KEY(watchlist_id, player_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_corporation (watchlist_id INT NOT NULL, corporation_id BIGINT NOT NULL, INDEX IDX_A47DFD6683DD0D94 (watchlist_id), INDEX IDX_A47DFD66B2685369 (corporation_id), PRIMARY KEY(watchlist_id, corporation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_alliance (watchlist_id INT NOT NULL, alliance_id BIGINT NOT NULL, INDEX IDX_412DA1EA83DD0D94 (watchlist_id), INDEX IDX_412DA1EA10A0EA3F (alliance_id), PRIMARY KEY(watchlist_id, alliance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE watchlist_group (watchlist_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_C313DF2983DD0D94 (watchlist_id), INDEX IDX_C313DF29FE54D947 (group_id), PRIMARY KEY(watchlist_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
