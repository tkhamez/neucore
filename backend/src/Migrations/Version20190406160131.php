...
final class Version20190406160131 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_applicant (player_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_A1E4CF8FE54D947 (group_id), INDEX IDX_A1E4CF899E6F5DF (player_id), PRIMARY KEY(player_id, group_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
