...
final class Version20210828113031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_eve_login (app_id INT NOT NULL, evelogin_id INT NOT NULL, INDEX IDX_7AD1F20A7987212D (app_id), INDEX IDX_7AD1F20A9E378596 (evelogin_id), PRIMARY KEY(app_id, evelogin_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
