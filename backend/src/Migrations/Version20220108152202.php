...
final class Version20220108152202 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_forbidden_groups (group_source INT NOT NULL, group_target INT NOT NULL, INDEX IDX_C09FA89E8C0CA7A3 (group_source), INDEX IDX_C09FA89E95E9F72C (group_target), PRIMARY KEY(group_source, group_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
