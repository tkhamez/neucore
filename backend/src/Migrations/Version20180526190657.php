...
final class Version20180526190657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alliance_group (alliance_id BIGINT NOT NULL, group_id INT NOT NULL, INDEX IDX_29B5059110A0EA3F (alliance_id), INDEX IDX_29B50591FE54D947 (group_id), PRIMARY KEY(alliance_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
