...
final class Version20190915112518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE corporation_group_tracking (corporation_id BIGINT NOT NULL, group_id INT NOT NULL, INDEX IDX_17E61049B2685369 (corporation_id), INDEX IDX_17E61049FE54D947 (group_id), PRIMARY KEY(corporation_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB');
