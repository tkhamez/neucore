...
final class Version20190414190312 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE group_required_groups (group_source INT NOT NULL, group_target INT NOT NULL, INDEX IDX_1B2DD19D8C0CA7A3 (group_source), INDEX IDX_1B2DD19D95E9F72C (group_target), PRIMARY KEY(group_source, group_target)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
