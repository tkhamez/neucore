...
class AuthControllerTest extends WebTestCase
{
    ...
    public function testCallback_InvalidStateException()
    {
        ...
        // @phpstan-ignore isset.offset, method.alreadyNarrowedType
    ...
    public function testCallback_DefaultSuccess()
    {
        ...
        $response = $this->runApp(
            ...
            null,
            [HttpClientFactoryInterface::class => new HttpClientFactory($this->client)],
            [['NEUCORE_EVE_SCOPES', 'read-this   and-this']],
        );
        $this->assertSame(302, $response->getStatusCode());
    ...
    /**
     * @psalm-return non-empty-string $prefix
     */
