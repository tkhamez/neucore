...
return [
    ...
    '/api/user/watchlist/exemption/add'      => ['PUT',  WatchlistController::class.'::exemptionAdd'],
    '/api/user/watchlist/exemption/remove'   => ['PUT',  WatchlistController::class.'::exemptionRemove'],
    '/api/user/watchlist/corporation/list'   => ['GET',  WatchlistController::class.'::corporationList'],
    '/api/user/watchlist/corporation/add'    => ['PUT',  WatchlistController::class.'::corporationAdd'],
    '/api/user/watchlist/corporation/remove' => ['PUT',  WatchlistController::class.'::corporationRemove'],
    '/api/user/watchlist/alliance/list'      => ['GET',  WatchlistController::class.'::allianceList'],
    '/api/user/watchlist/alliance/add'       => ['PUT',  WatchlistController::class.'::allianceAdd'],
    '/api/user/watchlist/alliance/remove'    => ['PUT',  WatchlistController::class.'::allianceRemove'],
    '/api/user/watchlist/group/list'         => ['GET',  WatchlistController::class.'::groupList'],
    '/api/user/watchlist/group/add'          => ['PUT',  WatchlistController::class.'::groupAdd'],
    '/api/user/watchlist/group/remove'       => ['PUT',  WatchlistController::class.'::groupRemove'],
];
