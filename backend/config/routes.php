...
return [
    ...
    '/api/user/watchlist/{id}/blacklist-corporation/list'                 => ['GET',  WatchlistController::class.'::blacklistCorporationList'],
    '/api/user/watchlist/{id}/blacklist-corporation/add/{corporation}'    => ['PUT',  WatchlistController::class.'::blacklistCorporationAdd'],
    '/api/user/watchlist/{id}/blacklist-corporation/remove/{corporation}' => ['PUT',  WatchlistController::class.'::blacklistCorporationRemove'],
    '/api/user/watchlist/{id}/blacklist-alliance/list'                    => ['GET',  WatchlistController::class.'::blacklistAllianceList'],
    '/api/user/watchlist/{id}/blacklist-alliance/add/{alliance}'          => ['PUT',  WatchlistController::class.'::blacklistAllianceAdd'],
    '/api/user/watchlist/{id}/blacklist-alliance/remove/{alliance}'       => ['PUT',  WatchlistController::class.'::blacklistAllianceRemove'],
    '/api/user/watchlist/{id}/whitelist-corporation/list'                 => ['GET',  WatchlistController::class.'::whitelistCorporationList'],
    '/api/user/watchlist/{id}/whitelist-corporation/add/{corporation}'    => ['PUT',  WatchlistController::class.'::whitelistCorporationAdd'],
    '/api/user/watchlist/{id}/whitelist-corporation/remove/{corporation}' => ['PUT',  WatchlistController::class.'::whitelistCorporationRemove'],
    '/api/user/watchlist/{id}/whitelist-alliance/list'                    => ['GET',  WatchlistController::class.'::whitelistAllianceList'],
    '/api/user/watchlist/{id}/whitelist-alliance/add/{alliance}'          => ['PUT',  WatchlistController::class.'::whitelistAllianceAdd'],
    '/api/user/watchlist/{id}/whitelist-alliance/remove/{alliance}'       => ['PUT',  WatchlistController::class.'::whitelistAllianceRemove'],
];
