...
return [
    ...
    '/api/user/watchlist/players'                 => ['GET',  WatchlistController::class.'::players'],
    '/api/user/watchlist/exemption/list'          => ['GET',  WatchlistController::class.'::exemptionList'],
    '/api/user/watchlist/exemption/add/{id}'      => ['PUT',  WatchlistController::class.'::exemptionAdd'],
    '/api/user/watchlist/exemption/remove/{id}'   => ['PUT',  WatchlistController::class.'::exemptionRemove'],
    '/api/user/watchlist/corporation/list'        => ['GET',  WatchlistController::class.'::corporationList'],
    '/api/user/watchlist/corporation/add/{id}'    => ['PUT',  WatchlistController::class.'::corporationAdd'],
    '/api/user/watchlist/corporation/remove/{id}' => ['PUT',  WatchlistController::class.'::corporationRemove'],
    '/api/user/watchlist/alliance/list'           => ['GET',  WatchlistController::class.'::allianceList'],
    '/api/user/watchlist/alliance/add/{id}'       => ['PUT',  WatchlistController::class.'::allianceAdd'],
    '/api/user/watchlist/alliance/remove/{id}'    => ['PUT',  WatchlistController::class.'::allianceRemove'],
    '/api/user/watchlist/group/list'              => ['GET',  WatchlistController::class.'::groupList'],
    '/api/user/watchlist/group/add/{id}'          => ['PUT',  WatchlistController::class.'::groupAdd'],
    '/api/user/watchlist/group/remove/{id}'       => ['PUT',  WatchlistController::class.'::groupRemove'],
];
